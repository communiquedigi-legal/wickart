...
const MOCK_GLOBAL_INVENTORY = [
  { id: 'PRD-101', name: 'Wireless Headphones', vendor: 'Silicon Valley Store', stock: 45, status: 'In Stock' },
  { id: 'PRD-102', name: 'Smart Fitness Band Pro', vendor: 'Silicon Valley Store', stock: 0, status: 'Out of Stock' },
  { id: 'PRD-103', name: 'Organic Green Tea', vendor: 'Fresh Organic Foods', stock: 8, status: 'Low Stock' },
  { id: 'PRD-104', name: 'Local Honey (500g)', vendor: 'Fresh Organic Foods', stock: 120, status: 'In Stock' },
  { id: 'PRD-105', name: 'Almonds 1kg', vendor: 'City Square Mart', stock: 2, status: 'Low Stock' },
];

export function VendorInventoryPage() {
  const [search, setSearch] = useState('');

  const filteredInventory = MOCK_GLOBAL_INVENTORY.filter(item => 
