    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-in fade-in duration-500">
      <div className="bg-white p-8 sm:p-12 border border-slate-100 shadow-sm rounded-3xl">
         ...
         <div className="prose prose-slate max-w-none space-y-6 text-slate-600">
            <p>
               Welcome to CityMart. This page contains our {title.toLowerCase()}. Please read these terms carefully before using our platform. By accessing or using our services, you agree to be bound by the terms outlined here.
            </p>
            
            <h3 className="text-xl font-bold text-slate-900 mt-8 mb-4">1. General Overview</h3>
            <p>
               These policies govern your use of the CityMart platform. We reserve the right to modify these terms at any time without prior notice. Continued use of the platform constitutes your acceptance of the revised terms.
            </p>
            ...
            <p>
               CityMart acts as a marketplace facilitator. We do not assume direct liability for the products sold by third-party vendors. Any disputes regarding product quality should be raised directly with the respective vendor through our support channels.
            </p>
