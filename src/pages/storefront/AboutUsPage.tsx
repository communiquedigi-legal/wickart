...
export function AboutUsPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-in fade-in duration-500 text-center">
      <h1 className="text-4xl font-bold text-slate-900 tracking-tight mb-6">About CityMart</h1>
      <p className="text-lg text-slate-600 leading-relaxed mb-8">
        CityMart is a premier multi-vendor marketplace dedicated exclusively to the residents of Sultanpur, Uttar Pradesh. 
