  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 animate-in fade-in duration-500">
      <div className="text-center mb-16">
         ...
         <p className="text-lg text-slate-600">We're here to help. Reach out to the CityMart team.</p>
      </div>
         ...
         <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
               ...
               <div>
                  ...
                  <p className="text-slate-600">Support: support@citymart.in<br/>Vendors: vendors@citymart.in</p>
               </div>
            </div>
         </div>
      </div>
