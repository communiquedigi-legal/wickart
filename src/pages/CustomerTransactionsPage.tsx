...
const MOCK_TXNS = [
  { id: 'TXN-0921', customer: 'Alok Nath', date: '06 Jun 2026', type: 'Payment', method: 'Credit Card', amount: '₹1,250.00', status: 'Success' },
  { id: 'TXN-0920', customer: 'Priya Desai', date: '05 Jun 2026', type: 'Refund', method: 'UPI', amount: '₹450.00', status: 'Success' },
  { id: 'TXN-0919', customer: 'Alok Nath', date: '01 Jun 2026', type: 'Payment', method: 'Wallet', amount: '₹3,200.00', status: 'Failed' },
];
